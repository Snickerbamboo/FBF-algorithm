...
class MyThreadMyOne implements Runnable {
	/*
	...
	public MyThreadMyOne(String[] String1, String[] String2) {
			...
			for (int i = 0; i < stringThread1.length; i++) {
				for (int j = 0; j < stringThread2.length; j++) {
					for (int k = 0; k < String3.length; k++) {
						...
						String grounddir = "E:\\csvJiHe\\office\\groundtruth\\";
						...
						String resultTXT = "";
						resultTXT = "E:\\csvJiHe\\resulttxtMy\\" + stringThread2[j] + String3[k] + ".txt";
...
public class GogoMyOne {
	public static void main(String[] args) {
		
		String[] stringThread11 = { "office" };
		String[] stringThread12 = { "3","13" };

		String[] stringThread21 = { "office" };
		String[] stringThread22 = { "9" };

		String[] stringThread31 = { "office" };
		String[] stringThread32 = { "10" };

		String[] stringThread41 = { "office" };
		String[] stringThread42 = { "11" };

		String[] stringThread51 = { "office" };
		String[] stringThread52 = { "12" };

		MyThreadMyOne mt1 = new MyThreadMyOne(stringThread11, stringThread12);
		MyThreadMyOne mt2 = new MyThreadMyOne(stringThread21, stringThread22);
		MyThreadMyOne mt3 = new MyThreadMyOne(stringThread31, stringThread32);
		MyThreadMyOne mt4 = new MyThreadMyOne(stringThread41, stringThread42);
		MyThreadMyOne mt5 = new MyThreadMyOne(stringThread51, stringThread52);
