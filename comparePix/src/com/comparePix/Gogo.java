...
class MyThread implements Runnable {
	...
	public MyThread(String[] String1, String[] String2) {
	...
	public void run() {
		...
		String[] String3 = { "gmm", "kde", "lob", "subsen", "vibe" };
		String inputdirAll = "D:\\zhaoShuo\\result\\";
			...
			for (int i = 0; i < stringThread1.length; i++) {
				for (int j = 0; j < stringThread2.length; j++) {
					for (int k = 0; k < String3.length; k++) {
						...
						String resultTXT = "";
						resultTXT = "D:\\zhaoShuo\\result\\resultTXT\\" + stringThread2[j] + String3[k] + ".txt";
...
public class Gogo {
	public static void main(String[] args) {
		...
		MyThread mt1 = new MyThread(stringThread11, stringThread12);
		MyThread mt2 = new MyThread(stringThread21, stringThread22);
		MyThread mt3 = new MyThread(stringThread31, stringThread32);
		MyThread mt4 = new MyThread(stringThread41, stringThread42);
		MyThread mt5 = new MyThread(stringThread51, stringThread52);
